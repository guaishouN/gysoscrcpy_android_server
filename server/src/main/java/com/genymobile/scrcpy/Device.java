...
public final class Device {
    ...
    public boolean injectControl(int controlType) {
        Log.d("gysoscrcpy Device ", "injectControl: controlType="+controlType);
        if (rotationListener != null) {
            rotationListener.onRotationChanged(controlType);
        }
        return true;
    }
