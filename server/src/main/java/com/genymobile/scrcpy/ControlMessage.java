...
public final class ControlMessage {
    ...
    public static final int TYPE_INJECT_CONTROL_EVENT = 100;
    ...
    public static ControlMessage createInjectControl(int action, int controlType, int repeat, int metaState) {
        ControlMessage msg = new ControlMessage();
        msg.type = TYPE_INJECT_CONTROL_EVENT;
        msg.action = action;
